    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  mbm-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MBM in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 MBM, 0.01 MBM, 0.1 MBM, 1 MBM and 10 MBM -- sort of like the paper money you use every day.</li> \
