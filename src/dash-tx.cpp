...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mbm-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mbm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mbm transaction") + "\n" +
              "  mbm-tx [options] -create [commands]   " + _("Create hex-encoded mbm transaction") + "\n" +
              "\n";
